      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex flex-col items-center relative ">
            <div className="flex items-end gap-3 mt-4 relative">
              <h2
              ...
              <div className="text-center">
                <div className="text-4xl font-bold text-[#1E88E5] leading-none">
                  {formatTime(timeLeft.days)}{" "}
                  <span className="text-[#1E88E5] text-2xl relative -top-1">
                    :
                  </span>
                </div>
          ...
          <div className="flex items-center">
            <button className="bg-[#E8F5E9] border border-[#C8E6C9] text-[#2E7D32] hover:bg-[#C8E6C9] px-4 py-1 rounded-xl shadow-sm transition-all duration-300 flex items-center font-medium cursor-pointer">
